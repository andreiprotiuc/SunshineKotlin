...
internal class OpenWeatherJsonParser {
    ...
    companion object {
        ...
        private fun fromJson(forecastJson: JSONObject): Array<WeatherEntry> {
            ...
            val weatherEntries = ArrayList<WeatherEntry>(jsonWeatherArray.length())
         ...
         */
            ...
            val arrayOfWeatherEntries = arrayOfNulls<WeatherEntry>(14)
            return weatherEntries.toArray(arrayOfWeatherEntries)
        }
